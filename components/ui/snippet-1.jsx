...
export const Snippet = ({
  ...
  return (
    <div
      className={clsx(
        "flex px-3 py-2.5 items-center rounded-md h-20 w-96 border border-gray-alpha-400",
        colors.background
      )}
      ...
      <div className="mr-3">
        {_text.map((item) => (
          <div
            key={item}
            className={clsx("font-mono px-3 text-[20px]", prompt && "before:content-['$_']", colors.text)}>
            {item}
          </div>
        ))}
      </div>
